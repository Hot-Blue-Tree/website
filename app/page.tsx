      ...
      <div className="container max-w-5xl mx-auto px-8 space-y-8 py-8 md:space-y-24 md:py-24">
        <section className="flex flex-col items-center">
          <h1 className="text-4xl font-bold mb-4">
            From AI Anxiety to Excitement — Hot Blue Tree Makes It Happen!
          </h1>
          <p className="text-xl mb-6">
            We specialise in building long-term partnerships to deliver tailored
            AI deployments that transform businesses and drive measurable
            results.
          </p>
        ...
        <section
          id="values"
          className="bg-slate-100 flex flex-col items-center p-4 rounded-xl"
        >
          <h2 className="text-3xl font-bold mb-4 text-center">
            Why Partner with Hot Blue Tree?
          </h2>
        ...
        <section className="mb-6">
          ...
          <p className="text-lg mb-6">
            Hot Blue Tree is all about helping small and medium-sized businesses
            unlock the potential of AI to make their operations smoother,
            smarter, and more innovative. We focus on creating custom solutions
            that fit your business needs, from streamlining processes to
            boosting productivity and showing clear, measurable results. Think
            of us as your partner in making AI work for you — whether that's
            building a roadmap for new technology, training your team to get
            comfortable with it, or making sure your data stays safe. We work
            with businesses that are ready to embrace change and see the value
            AI can bring, even if they're not tech experts. Our goal is to make
            AI approachable, affordable, and a game-changer for your business.
          </p>
